...
import TransactionSectionContent from './TransactionSectionContent';
import InflowsSectionContent from './InflowSectionContent';
...
const WalletContent = ({ setActiveComponent }: WalletContentProps) => {
