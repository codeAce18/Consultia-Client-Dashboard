    ...
    return(
        ...
        <div>
            ...
            <div>
                ...
                <h1 className="text-[#101828] text-[39px] leading-[46.8px] font-medium">₦ 00.<span className="text-[24px] leading-[28.8px]">00</span></h1>
            </div>
                ...
                <div className="flex flex-wrap items-start lg:gap-32 gap-16">
                    <div className="flex  flex-col lg:flex-row md:flex-row lg:items-center lg:justify-center items-start justify-start rounded-[10.58px] shadow-custom-lg gap-16 bg-[#FFFFFF] p-[30px] max-w-[565px] w-full">
                        <div className="space-y-[20px]">
                            ...
                            <div>
                                <h1 className="text-[#101828] text-[20px] leading-[30px] font-semibold whitespace-nowrap">PAUL OSEGHALE
                    ...
                    <div className="space-y-[10px]">
                        ...
                        <div className="flex flex-col items-start space-y-[20px]">
                            ...
                            <div className="flex items-center gap-[10px]">
                                ...
                                <h1 className="text-[#A3A2AB] text-[13px] leading-[19.5px] font-normal">Copy Details</h1>
                            </div>
