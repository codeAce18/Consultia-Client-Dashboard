...
const ExpenditureAnalysisChart = () => {
  ...
  return (
    <div className="flex flex-col shadow-custom-light items-start bg-[#FFFFFF] w-[738px] h-[336px] rounded-[8px] border-[1.06px] border-[#F8F9FA]">
      {/* Header with Dropdown */}
      <div className="flex items-center gap-[400px] mb-4 pt-4">
